...
async def run_ingestion(newsapi_key: str, newsapi_query: str, rss_urls: List[str]) -> List[RawArticle]:
    """
    ...
    for result in results:
        ...
        for item in result:
            try:
                ...
                logger.warning(f"Skipping corrupted article due to validation error")
